...
## having trouble with boost libraries, so using silix 1.2.9
~/software/silix-1.2.9/src/silix  MTEC_TIR.fa MTEC_TIR.allvall.out -f MTEC -i 0.8 -r 0.8 --net > MTEC_TIR.8080.fnodes
